...
for (let i = 0; i < entidadesColumn1Count; i++) {   
 ...
 for (let i = entidadesColumn1Count + entidadesColumn2Count; i < entidades.length; i++) {   
  ...
  const salud = [
        ...
        "DR. IGNACIO AGUIRRE (Bioquímico) - Cordoba - Argentina",
        "DRA. CARMEN LENT (Psicóloga) - BRASIL",
        ...
        "DR. ROBERTO A. COLLA (Bioquímico) Río Tercero, Córdoba - Argentina",
        "DRA. PAULA MOYANO (Ginecóloga/Obstetra) Portland, Oregon - EEUU",
        "DR. GUSTAVO GRET (Infectologo) Bs As - Argentina",
        "DR. DANIEL FORSTER (Psiquiatra) Cap.Fed - Argentina",
        "DRA. GABRIELA SICA (Médica infectologa) Bs As - Argentina",
        ...
        "DRA. GABRIELA PIOVANO (Médica) Buenos Aires - Argentina",
        ...
        "LIC. DOLORES FENOY (Psicóloga) Buenos Aires - Argentina",
        ...
        "LIC. LAURA VULCANO (Psicóloga) Buenos Aires - Argentina",
        "DR. OMAR SUED (médico infectólogo) - Argentina",
        "DRA. MARIANA CECILIA CUPITO (Psicóloga) Buenos Aires - Argentina",
        "DRA. SUSANA HERMOSID (Hosp. Durand) Bs.As - Argentina",
        "LIC. ALEJANDRO M. FRIDMAN (Docente) Buenos Aires - Argentina",
        "DRA. DANIELA GARONE (Médica infectóloga) Buenos Aires - Argentina",
        ...
        "Dr. RAUL SARNO (Médico) Buenos Aires - Argentina",
        "LIC. MONICA GRANOVSKY (Psicóloga) Buenos Aires - Argentina",
        "DRA. MARIA C. HISI (Psicóloga) Capital - Argentina",
        "LIC. MARCELA P PELLEGRINO (Psicóloga) Buenos Aires - Argentina",
        "LIC. MARIA CECILIA JUSTO (Psicoanalista) Capital - Argentina",
        "DRA. MARTHA CHAVES DE DUTTO (Tocoginecóloga, prevención y salud reproductiva) Río Tercero, Córdoba - Arg",
        ...
        "LIC. RUBEN NESTOR SCARPA (Psicólogo) Chaco - Argentina",
